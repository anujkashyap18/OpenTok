...
public class ScreenSharingCapture extends BaseVideoCapturer {
	...
	private Runnable newFrame = new Runnable() {
		...
		public void run() {
			if (capturing) {
				...
				if (frame == null ||
						ScreenSharingCapture.this.width != width ||
						ScreenSharingCapture.this.height != height) {
	...
	public ScreenSharingCapture(Context context, View view) {
